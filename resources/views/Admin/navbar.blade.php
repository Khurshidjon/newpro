    ...
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{route('admin.createPage')}}"><i class="fa fa-product-hunt fa-fw"></i>Add new Product</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.newUserPage') }}"><i class="fa fa-user fa-fw"></i> Add new User</a>
                    </li>
                    <li>
                        <a href="3"> <i class="fa fa-inbox"></i> Add new Category</a>
                    </li>
                    <li>
                        <a href="3"><i class="fa fa-map-marker"></i> Add new Country</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                <a href="{{route('admin.productPage')}}"><i class="fa fa-shopping-bag fa-fw"></i> Products</a>
            </li>
            <li>
