                                                    ...
                                                    <tr>
                                                        <td>
                                                            @foreach($role->permissions as $permission)
                                                                <form action="{{ route('admin.detachPermissionFromRole', [$role, $permission]) }}" method="post">
                                                                    {{ csrf_field() }}
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @foreach($permissions->diff($role->permissions) as $permission)
                                                                <form action="{{ route('admin.attachPermissionToRole', [$role, $permission]) }}" method="post">
                                                                    {{ csrf_field() }}
                                                                    <label class="badge badge-success">{{ $permission->name }}</label>
                                                                    <button class="btn btn-light" type="submit" style="background-color: white">
